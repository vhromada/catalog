...
class SongFacadeSpringTest {
    ...
    fun findAllPaging() {
        for (i in 1..MusicUtils.MUSIC_COUNT) {
            ...
            assertSoftly {
                ...
                it.assertThat(result.pagesCount).isEqualTo(SongUtils.SONGS_PER_MUSIC_COUNT)
            }
    ...
    fun add() {
        ...
        SongUtils.assertSongDeepEquals(expected = expectedDomainSong, actual = SongUtils.getDomainSong(entityManager = entityManager, id = SongUtils.SONGS_COUNT + 1))
    ...
    fun duplicate() {
        ...
        val expectedDomainSong = music.songs.first()
            .copy(id = SongUtils.SONGS_COUNT + 1, uuid = TestConstants.UUID)
            .fillAudit(audit = AuditUtils.newAudit())
