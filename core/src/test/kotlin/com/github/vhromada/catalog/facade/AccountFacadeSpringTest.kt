...
class AccountFacadeSpringTest {
    ...
    fun searchPaging() {
        ...
        assertSoftly {
            ...
            it.assertThat(result.pagesCount).isEqualTo(AccountUtils.ACCOUNTS_COUNT)
        }
    ...
    fun addCredentials() {
        ...
        AccountUtils.assertAccountDeepEquals(expected = expectedAccount, actual = result)
        AccountUtils.assertAccountDeepEquals(expected = expectedDomainAccount, actual = AccountUtils.getDomainAccount(entityManager = entityManager, id = AccountUtils.ACCOUNTS_COUNT + 1))
