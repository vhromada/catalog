...
import com.github.vhromada.catalog.entity.ChangeBookRequest
...
object BookUtils {
     ...
     */
    fun assertBookDeepEquals(expected: com.github.vhromada.catalog.domain.Book?, actual: com.github.vhromada.catalog.domain.Book?, checkBookItems: Boolean = true) {
        if (expected == null) {
            ...
            if (checkBookItems) {
                BookItemUtils.assertDomainBookItemsDeepEquals(expected = expected.items, actual = actual.items)
            }
        }
    }
     ...
     * @param actual   actual book
     */
    fun assertBookDeepEquals(expected: com.github.vhromada.catalog.domain.Book, actual: Book) {
        assertSoftly {
            it.assertThat(actual.uuid).isEqualTo(expected.uuid)
            it.assertThat(actual.uuid).isEqualTo(expected.uuid)
            it.assertThat(actual.czechName).isEqualTo(expected.czechName)
