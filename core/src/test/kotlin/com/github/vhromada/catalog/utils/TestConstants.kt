...
object TestConstants {
     ...
     */
    val INVALID_MOVIE_IMDB_CODE_EVENT = Event(severity = Severity.ERROR, key = "MOVIE_IMDB_CODE_NOT_VALID", message = "IMDB code must be between 1 and 999999999 or -1.")

    /**
     * Event for invalid movie IMDB code
     */
    val INVALID_SHOW_IMDB_CODE_EVENT = Event(severity = Severity.ERROR, key = "SHOW_IMDB_CODE_NOT_VALID", message = "IMDB code must be between 1 and 999999999 or -1.")
     ...
     */
    val INVALID_ISSUE_YEAR_EVENT = Event(severity = Severity.ERROR, key = "BOOK_ISSUE_YEAR_NOT_VALID", message = "Issue year must be between ${Constants.MIN_YEAR} and ${Constants.CURRENT_YEAR}.")
