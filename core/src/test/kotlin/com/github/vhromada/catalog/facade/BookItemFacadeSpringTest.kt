...
class BookItemFacadeSpringTest {
    ...
    fun findAllPaging() {
        for (i in 1..BookUtils.BOOKS_COUNT) {
            ...
            assertSoftly {
                ...
                it.assertThat(result.pagesCount).isEqualTo(BookItemUtils.BOOK_ITEMS_PER_BOOK_COUNT)
            }
    ...
    fun add() {
        ...
        BookItemUtils.assertBookItemDeepEquals(expected = expectedDomainBookItem, actual = BookItemUtils.getDomainBookItem(entityManager = entityManager, id = BookItemUtils.BOOK_ITEMS_COUNT + 1))
    ...
    fun duplicate() {
        ...
        val expectedDomainBookItem = book.items.first()
            .copy(id = BookItemUtils.BOOK_ITEMS_COUNT + 1, uuid = TestConstants.UUID)
            .fillAudit(audit = AuditUtils.newAudit())
