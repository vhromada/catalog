...
class MovieFacadeSpringTest {
    ...
    fun searchPaging() {
        ...
        assertSoftly {
            ...
            it.assertThat(result.pagesCount).isEqualTo(MovieUtils.MOVIES_COUNT)
        }
    ...
    fun add() {
        ...
        MovieUtils.assertMovieDeepEquals(expected = expectedDomainMovie, actual = MovieUtils.getDomainMovie(entityManager = entityManager, id = MovieUtils.MOVIES_COUNT + 1))
    ...
    fun duplicate() {
        ...
        val expectedDomainMovie = MovieUtils.getDomainMovie(index = 1)
            .copy(id = MovieUtils.MOVIES_COUNT + 1, uuid = TestConstants.UUID)
            .fillAudit(audit = AuditUtils.newAudit())
        val expectedDomainMedia = expectedDomainMovie.media.mapIndexed { index, medium ->
            medium.copy(id = MediumUtils.MEDIA_COUNT + index + 1)
                .fillAudit(audit = AuditUtils.newAudit())
