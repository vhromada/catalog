...
object AccountUtils {
     ...
     */
    fun assertAccountDeepEquals(expected: com.github.vhromada.catalog.domain.Account?, actual: com.github.vhromada.catalog.domain.Account?) {
        if (expected == null) {
     ...
     * @param actual   actual account
     */
    fun assertAccountDeepEquals(expected: com.github.vhromada.catalog.domain.Account, actual: Account) {
        assertSoftly {
            it.assertThat(actual.uuid).isEqualTo(expected.uuid)
            it.assertThat(actual.username).isEqualTo(expected.username)
            it.assertThat(actual.locked).isEqualTo(expected.locked)
