...
import com.github.vhromada.catalog.entity.ChangeGameRequest
...
object GameUtils {
     ...
     */
    fun assertGameDeepEquals(expected: com.github.vhromada.catalog.domain.Game?, actual: com.github.vhromada.catalog.domain.Game?, checkCheat: Boolean = true) {
        if (expected == null) {
     ...
     * @param actual   actual game
     */
    fun assertGameDeepEquals(expected: Game, actual: Game) {
        assertSoftly {
            it.assertThat(actual.uuid).isEqualTo(expected.uuid)
            it.assertThat(actual.name).isEqualTo(expected.name)
            it.assertThat(actual.wikiEn).isEqualTo(expected.wikiEn)
