...
import com.github.vhromada.catalog.filter.AuthorFilter
...
class AuthorFacadeSpringTest {
    ...
    fun searchPaging() {
        ...
        assertSoftly {
            ...
            it.assertThat(result.pagesCount).isEqualTo(AuthorUtils.AUTHORS_COUNT)
        }
    ...
    fun add() {
        ...
        AuthorUtils.assertAuthorDeepEquals(expected = expectedDomainAuthor, actual = AuthorUtils.getDomainAuthor(entityManager = entityManager, id = AuthorUtils.AUTHORS_COUNT + 1))
    ...
    fun duplicate() {
        ...
        val expectedDomainAuthor = AuthorUtils.getDomainAuthor(index = 1)
            .copy(id = AuthorUtils.AUTHORS_COUNT + 1, uuid = TestConstants.UUID)
            .fillAudit(audit = AuditUtils.newAudit())
