...
class GameFacadeSpringTest {
    ...
    fun searchPaging() {
        ...
        assertSoftly {
            ...
            it.assertThat(result.pagesCount).isEqualTo(GameUtils.GAMES_COUNT)
        }
    ...
    fun add() {
        ...
        GameUtils.assertGameDeepEquals(expected = expectedDomainGame, actual = GameUtils.getDomainGame(entityManager = entityManager, id = GameUtils.GAMES_COUNT + 1))
    ...
    fun duplicate() {
        ...
        val expectedDomainGame = GameUtils.getDomainGame(index = 1)
            .copy(id = GameUtils.GAMES_COUNT + 1, uuid = TestConstants.UUID)
            .fillAudit(audit = AuditUtils.newAudit())
