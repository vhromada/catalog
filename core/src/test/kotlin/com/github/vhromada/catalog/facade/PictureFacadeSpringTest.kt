...
class PictureFacadeSpringTest {
    ...
    fun searchPaging() {
        ...
        assertSoftly {
            ...
            it.assertThat(result.pagesCount).isEqualTo(PictureUtils.PICTURES_COUNT)
        }
    ...
    fun add() {
        ...
        PictureUtils.assertPictureDeepEquals(expected = expectedDomainPicture, actual = PictureUtils.getDomainPicture(entityManager = entityManager, id = PictureUtils.PICTURES_COUNT + 1))
