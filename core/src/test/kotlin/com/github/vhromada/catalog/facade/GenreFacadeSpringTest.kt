...
class GenreFacadeSpringTest {
    ...
    fun searchPaging() {
        ...
        assertSoftly {
            ...
            it.assertThat(result.pagesCount).isEqualTo(GenreUtils.GENRES_COUNT)
        }
    ...
    fun add() {
        ...
        GenreUtils.assertGenreDeepEquals(expected = expectedDomainGenre, actual = GenreUtils.getDomainGenre(entityManager = entityManager, id = GenreUtils.GENRES_COUNT + 1))
    ...
    fun duplicate() {
        ...
        val expectedDomainGenre = GenreUtils.getDomainGenre(index = 1)
            .copy(id = GenreUtils.GENRES_COUNT + 1, uuid = TestConstants.UUID)
            .fillAudit(audit = AuditUtils.newAudit())
