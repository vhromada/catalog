...
class ProgramFacadeSpringTest {
    ...
    fun searchPaging() {
        ...
        assertSoftly {
            ...
            it.assertThat(result.pagesCount).isEqualTo(ProgramUtils.PROGRAMS_COUNT)
        }
    ...
    fun add() {
        ...
        ProgramUtils.assertProgramDeepEquals(expected = expectedDomainProgram, actual = ProgramUtils.getDomainProgram(entityManager = entityManager, id = ProgramUtils.PROGRAMS_COUNT + 1))
    ...
    fun duplicate() {
        ...
        val expectedDomainProgram = ProgramUtils.getDomainProgram(index = 1)
            .copy(id = ProgramUtils.PROGRAMS_COUNT + 1, uuid = TestConstants.UUID)
            .fillAudit(audit = AuditUtils.newAudit())
