...
import com.github.vhromada.catalog.entity.ChangeAuthorRequest
...
object AuthorUtils {
     ...
     */
    fun newFilter(): com.github.vhromada.catalog.filter.AuthorFilter {
        return com.github.vhromada.catalog.filter.AuthorFilter(
            firstName = "firstName",
            middleName = "middleName",
            lastName = "lastName"
        )
     ...
     */
    fun assertAuthorDeepEquals(expected: com.github.vhromada.catalog.domain.Author?, actual: com.github.vhromada.catalog.domain.Author?) {
        if (expected == null) {
     ...
     * @param actual   actual author
     */
    fun assertAuthorDeepEquals(expected: com.github.vhromada.catalog.domain.Author, actual: Author) {
        assertSoftly {
            it.assertThat(actual.uuid).isEqualTo(expected.uuid)
            it.assertThat(actual.firstName).isEqualTo(expected.firstName)
            it.assertThat(actual.middleName).isEqualTo(expected.middleName)
     ...
     */
    fun assertFilterDeepEquals(expected: com.github.vhromada.catalog.filter.AuthorFilter, actual: AuthorFilter) {
        assertSoftly {
            it.assertThat(actual.firstName).isEqualTo(expected.firstName)
            it.assertThat(actual.middleName).isEqualTo(expected.middleName)
            it.assertThat(actual.lastName).isEqualTo(expected.lastName)
