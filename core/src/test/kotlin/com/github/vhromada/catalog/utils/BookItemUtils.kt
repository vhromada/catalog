...
object BookItemUtils {
     ...
     */
    fun assertDomainBookItemsDeepEquals(expected: List<com.github.vhromada.catalog.domain.BookItem>, actual: List<com.github.vhromada.catalog.domain.BookItem>) {
     ...
     */
    fun assertBookItemDeepEquals(expected: com.github.vhromada.catalog.domain.BookItem?, actual: com.github.vhromada.catalog.domain.BookItem?) {
        if (expected == null) {
            ...
            if (expected.book != null) {
                ...
                BookUtils.assertBookDeepEquals(expected = expected.book!!, actual = actual.book!!, checkBookItems = false)
            }
        }
    }
     ...
     * @param actual   actual book item
     */
    fun assertBookItemDeepEquals(expected: com.github.vhromada.catalog.domain.BookItem, actual: BookItem) {
        assertSoftly {
            it.assertThat(actual.uuid).isEqualTo(expected.uuid)
            it.assertThat(actual.languages)
                .hasSameSizeAs(expected.languages)
     ...
     * @param actual   actual book item
     */
    fun assertBookItemDeepEquals(expected: BookItem, actual: BookItem) {
        assertSoftly {
            it.assertThat(actual.uuid).isEqualTo(expected.uuid)
            it.assertThat(actual.languages)
                .hasSameSizeAs(expected.languages)
