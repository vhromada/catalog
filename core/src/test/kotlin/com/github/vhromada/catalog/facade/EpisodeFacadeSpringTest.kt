...
class EpisodeFacadeSpringTest {
        ...
        for (i in 1..ShowUtils.SHOWS_COUNT) {
            ...
            for (season in show.seasons) {
                ...
                assertSoftly {
                    ...
                    it.assertThat(result.pagesCount).isEqualTo(EpisodeUtils.EPISODES_PER_SEASON_COUNT)
                }
    ...
    fun add() {
        ...
        EpisodeUtils.assertEpisodeDeepEquals(expected = expectedDomainEpisode, actual = EpisodeUtils.getDomainEpisode(entityManager = entityManager, id = EpisodeUtils.EPISODES_COUNT + 1))
    ...
    fun duplicate() {
        ...
        val expectedDomainEpisode = season.episodes.first()
            .copy(id = EpisodeUtils.EPISODES_COUNT + 1, uuid = TestConstants.UUID)
            .fillAudit(audit = AuditUtils.newAudit())
