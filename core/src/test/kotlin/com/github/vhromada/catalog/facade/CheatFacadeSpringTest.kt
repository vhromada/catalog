...
class CheatFacadeSpringTest {
    ...
    fun add() {
        ...
        CheatUtils.assertCheatDeepEquals(expected = expectedDomainCheat, actual = CheatUtils.getDomainCheat(entityManager = entityManager, id = CheatUtils.CHEATS_COUNT + 1))
