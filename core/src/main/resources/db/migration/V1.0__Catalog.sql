...
CREATE SEQUENCE registers_sq START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE register_values_sq START WITH 1 INCREMENT BY 1;
...
CREATE TABLE movies (
  ...
  csfd                     VARCHAR(100),
  imdb_code                INTEGER      CONSTRAINT movies_imdb_code_ck CHECK (imdb_code BETWEEN 1 AND 999999999 OR imdb_code = -1),
  wiki_en                  VARCHAR(100),
  wiki_cz                  VARCHAR(100),
  note                     VARCHAR(100),
  created_user             VARCHAR(36)  NOT NULL,
...
CREATE TABLE tv_shows (
  ...
  csfd                     VARCHAR(100),
  imdb_code                INTEGER      CONSTRAINT tv_shows_imdb_code_ck CHECK (imdb_code BETWEEN 1 AND 999999999 OR imdb_code = -1),
  wiki_en                  VARCHAR(100),
  wiki_cz                  VARCHAR(100),
  note                     VARCHAR(100),
  created_user             VARCHAR(36)  NOT NULL,
...
CREATE SEQUENCE book_items_sq START WITH 1 INCREMENT BY 1;
...
CREATE TABLE book_item_languages (
...
INSERT INTO roles (id, role_name) VALUES (NEXT VALUE FOR roles_sq, 'ROLE_ADMIN');
INSERT INTO roles (id, role_name) VALUES (NEXT VALUE FOR roles_sq, 'ROLE_USER');
INSERT INTO accounts (id, uuid, username, password, locked) VALUES (NEXT VALUE FOR accounts_sq, 'dc0d73bc-e19e-4c91-b818-192907def7ec', 'admin', '$2a$10$CKwbyaXtgmTIFJj07XGPPOR3Qn8zCNUHN97/C9tm1oEGv.hJNEJU.', false);
...
INSERT INTO registers (id, register_number, register_name) VALUES (NEXT VALUE FOR registers_sq, 1, 'Program formats');
INSERT INTO registers (id, register_number, register_name) VALUES (NEXT VALUE FOR registers_sq, 2, 'Languages');
INSERT INTO registers (id, register_number, register_name) VALUES (NEXT VALUE FOR registers_sq, 3, 'Subtitles');
INSERT INTO registers (id, register_number, register_name) VALUES (NEXT VALUE FOR registers_sq, 4, 'Book item formats');

INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 1), 'ISO', 1);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 1), 'BINARY', 2);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 1), 'STEAM', 3);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 1), 'BATTLE_NET', 4);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 2), 'CZ', 1);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 2), 'EN', 2);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 2), 'FR', 3);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 2), 'JP', 4);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 2), 'SK', 5);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 3), 'CZ', 1);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 3), 'EN', 2);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 4), 'PAPER', 1);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 4), 'PDF', 2);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 4), 'DOC', 3);
INSERT INTO register_values (id, register, register_code, register_order) VALUES (NEXT VALUE FOR register_values_sq, (SELECT id FROM registers WHERE register_number = 4), 'TXT', 4);
