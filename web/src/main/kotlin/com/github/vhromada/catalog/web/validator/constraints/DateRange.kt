...
import com.github.vhromada.catalog.web.validator.DateRangeValidator
...
annotation class DateRange(
     ...
     */
    val message: String = "{com.github.vhromada.catalog.web.validator.constraints.DateRange.message}",
