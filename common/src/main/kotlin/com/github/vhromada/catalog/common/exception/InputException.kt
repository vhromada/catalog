package com.github.vhromada.catalog.common.exception
 ...
 */
class InputException(val result: Result<*>, val httpStatus: HttpStatusCode = HttpStatus.UNPROCESSABLE_ENTITY) : RuntimeException(result.toString()) {
